...
void app_main(void)
{
    ...
    while (1)
    {
        ...
        {
            if (/*msg.cmd == PERIPH_TOUCH_TAP || */ msg.cmd == PERIPH_BUTTON_RELEASE /* || msg.cmd == PERIPH_ADC_BUTTON_PRESSED*/)
            {
            ...
            else if (msg.cmd == PERIPH_TOUCH_LONG_TAP || msg.cmd == PERIPH_BUTTON_LONG_PRESSED || msg.cmd == PERIPH_ADC_BUTTON_LONG_PRESSED)
            {
                if ((int)msg.data == get_input_volup_id())
                {
                    ESP_LOGI(TAG, "[ * ] [Vol+] long touch tap event");
            ...
            else if (msg.cmd == PERIPH_TOUCH_TAP ||  msg.cmd == PERIPH_BUTTON_RELEASE  || msg.cmd == PERIPH_ADC_BUTTON_PRESSED)
            {
